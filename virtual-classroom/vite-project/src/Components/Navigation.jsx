...
export default function Navigation({ userName, userAvatar }) {
  ...
  const settingsMenuItems = [
    ...
    { label: 'Developer Options', action: () => alert('Developer Options coming soon') },
    { label: 'App Preferences', action: () => alert('App Preferences coming soon') },
    { label: 'Notification & Sounds', action: () => alert('Notification & Sounds coming soon') },
    { label: 'Security & Privacy', action: () => alert('Security & Privacy coming soon') },
    { label: 'Account Settings', action: () => alert('Account Settings coming soon') },
    { label: 'General Settings', action: () => alert('General Settings coming soon') },
  ];
            ...
            <nav className="hidden md:flex space-x-1">
              {['Dashboard', 'Courses', 'Calendar', 'Resources'].map((item) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${activeNav === item.toLowerCase()
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              ...
              >
                ...
                />
                {/* <span className="hidden md:inline font-medium pr-2">User</span> */}
              </button>

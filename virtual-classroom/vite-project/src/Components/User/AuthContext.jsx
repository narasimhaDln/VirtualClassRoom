...
export const AuthProvider = ({ children }) => {
  ...
  // https://virtualclassroom-project-default-rtdb.firebaseio.com/Users
  // const verifyToken = async (token) => {
  //   try {
  //     const response = await fetch('https://virtualclassroom-project-default-rtdb.firebaseio.com/Users.json/verify-token', {
  //       headers: {
